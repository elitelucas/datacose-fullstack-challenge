    ...
    <div class="row">
      <div class="col-md-6">
        <div class="about">
          ...
          <p>
            My name is Lucas Wang, I am a <b>front-end developer</b> and
...
export default {
  ...
  head: {
    title: "About 🕵️‍♂️ - Lucas Wang",
    meta: [
      {
        hid: "description",
        name: "description",
        // currYear - startYear
        content: `Hey there 👋 My name is Lucas Wang, i am a front-end developer and technical writer currently studying Computer Science at OAUSTECH(Nigeria). i have many years of experience in crafting beautiful web and mobile interfaces. Plus i am an agile learner, i learn new cool stuffs everyday.`
      }
    ]
  }
};
