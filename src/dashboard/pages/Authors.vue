<template>
  <b-container class="page  animate__animated animate__fadeIn">
    ...
    <b-row>
      ...
      <b-col lg="6" class="my-1">
        <b-button v-b-modal.modal-1 id="createbutton" variant="success">Add Author</b-button>
      </b-col>
    </b-row>
    ...
    >
      ...
      <template #cell(actions)="row">
        <b-button size="sm" @click="onClickDelete(row.item.id)" class="mr-1" variant="danger">
          Delete
        </b-button>
      </template>
    </b-table>
