...
export default {
  ...
  head: {
    title: "Recent Articles 📚 - Lucas Wang",
    meta: [
      {
        hid: "description",
        name: "description",
        content:
          "Read articles written by Lucas Wang, articles include topics under web development (html, css, javascript), mobile app development and many more."
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Recent Articles 📚 - Lucas Wang"
      },
      {
        property: "og:description",
        content: "Read articles written by Lucas Wang, articles include topics under web development (html, css, javascript), mobile app development and many more."
      },
    ]
  },
  methods: {
        ...
        .then(data => {
          data.forEach(article => {
            ...
            this.blogs.push({
              ...
              imgAlt: article.title + " - Lucas Wang"
            });
          });
          success();
        })
